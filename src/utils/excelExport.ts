...
export function generateStationWorksheetData(reportData: MaintenanceReportData): any[][] {
  ...
  rows.push([
    ...
    totalM > 0 ? totalM : clean(reportData.overallTotals?.mTotal),
    totalM2 > 0 ? totalM2 : clean(reportData.overallTotals?.m2Total),
    totalM3 > 0 ? totalM3 : clean(reportData.overallTotals?.m3Total),
    totalM4 > 0 ? totalM4 : clean(reportData.overallTotals?.m4Total),
    totalM6 > 0 ? totalM6 : clean(reportData.overallTotals?.m6Total),
    totalY > 0 ? totalY : clean(reportData.overallTotals?.yTotal),
    totalM18 > 0 ? totalM18 : clean(reportData.overallTotals?.m18Total),
    totalY2 > 0 ? totalY2 : clean(reportData.overallTotals?.y2Total),
    totalY3 > 0 ? totalY3 : clean(reportData.overallTotals?.y3Total),
  ]);
